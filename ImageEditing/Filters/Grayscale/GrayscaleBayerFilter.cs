...
{
	public class GrayscaleBayerFilter : BaseFilter
	{
		...
		public GrayscaleBayerFilter(short[,] bayerPattern)
			: this()
		{
			this.bayerPattern = bayerPattern;
		}

		public GrayscaleBayerFilter(string bayerPattern)
